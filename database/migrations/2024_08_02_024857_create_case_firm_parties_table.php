...
return new class extends Migration
{
    ...
    {
        Schema::create('case_firm_parties', function (Blueprint $table) {
            $table->id();
            $table->foreignIdFor(FirmParty::class)->constrained()->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('case_firm_parties');
    }
};
