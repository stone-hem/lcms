...
class CountriesSeeder extends Seeder
{
    ...
    public function run(): void
    {
      $countries_json = '{
        ...
        $decode = json_decode($countries_json);
        foreach ($decode as $key => $value) {
            $country = Country::where('country_code', $value->{'country-code'})->first();
            if (!$country) {
                $country = new Country();
                try {
                ...
                $country->citizenship = $value->citizenship;
                $country->country_code = $value->{'country-code'};
                try {
                    //code...
                ...
                try {
                    //code...
                    $country->currency_sub_unit = $value->currency_sub_unit;
                } catch (\Throwable $th) {
                    //throw $th;
                }
                try {
                    //code...
                    $country->full_name = $value->full_name;
                } catch (\Throwable $th) {
                    //throw $th;
                }
                $country->iso_3166_2 = $value->iso_3166_2;
                $country->iso_3166_3 = $value->iso_3166_3;
                $country->name = $value->name;
                $country->region_code = $value->{'region-code'};
                $country->sub_region_code = $value->{'sub-region-code'};
                $country->eea = $value->eea;
                $country->calling_code = $value->calling_code;
                try {
                    //code...
                ...
                try {
                    $country->currency_decimals = $value->currency_decimals;
                    //code...
                } catch (\Throwable $th) {
                    //throw $th;
                }
